    ...
    return (
        <>
            ...
            <nav ref={navRef} className='fixed w-full top-0 z-40 py-4 px-5 md:px-10 xl:px-20 flex items-center justify-between opacity-0 '>
                    ...
                    <div className="flex flex-col w-full gap-5 mt-14 sm:mt-4 flex-grow">
                        ...
                        <div className="flex flex-col gap-4 text-4xl leading-normal px-5 text-right sm:text-left">
                            {NAV_OPTIONS.map((item, index) => (
                                <a onClick={() => handleNav()} href={item.url} key={index} className='inline-block max-w-max'>
                ...
                <MagneticEffect>
                    <div className={'flex flex-col items-center justify-center gap-1.5 bg-white dark:bg-gray-50 dark:bg-opacity-50 bg-opacity-20 rounded-full p-1 w-16 h-16 cursor-pointer z-50 group relative ' + (active ? "" : "hover:bg-opacity-30")} onClick={handleNav}>
                        ...
                        <div className='flex flex-col items-center justify-center gap-1.5 menu relative'>
                            <div className='w-10 h-1 rounded-full bg-white dark:bg-gray-50 line1'></div>
                            <div className='w-7 h-1 mr-auto rounded-full bg-white dark:bg-gray-50 line2'></div>
                            <div className='w-4 h-1 mr-auto rounded-full bg-white dark:bg-gray-50 line3'></div>
                        </div>
                    </div>
                </MagneticEffect>
            </nav>
